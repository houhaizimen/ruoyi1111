<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="藏品号" prop="colletNo">
        <el-input
          v-model="queryParams.colletNo"
          placeholder="请输入藏品号"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="museumList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="藏品号" align="center" prop="colletNo" />
      <el-table-column label="地域" align="center" prop="area" />
      <el-table-column label="年代" align="center" prop="years" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="藏品号" prop="colletNo">
          <el-input v-model="form.colletNo" placeholder="请输入藏品号" />
        </el-form-item>
        <el-form-item label="地域" prop="area">
          <el-input v-model="form.area" placeholder="请输入地域" />
        </el-form-item>
        <el-form-item label="年代" prop="years">
          <el-input v-model="form.years" placeholder="请输入年代" />
        </el-form-item>
        <el-form-item label="质地" prop="material">
          <el-input v-model="form.material" placeholder="请输入质地" />
        </el-form-item>
        <el-form-item label="数量" prop="quantity">
...
<script>
import { listMuseum, getMuseum, delMuseum, addMuseum, updateMuseum } from "@/api/system/museum";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除皮影信息f编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/museum/export', {
        ...this.queryParams
