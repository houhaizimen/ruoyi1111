<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="关系索引" prop="idx">
        <el-input
    ...
    <el-table v-loading="loading" :data="relationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="关系索引" align="center" prop="idx" />
      <el-table-column label="关系名" align="center" prop="name" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="关系索引" prop="idx">
          <el-input v-model="form.idx" placeholder="请输入关系索引" />
        </el-form-item>
        <el-form-item label="关系名" prop="name">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        idx: [
          { required: true, message: "关系索引不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除实体关系编号为"' + ids + '"的数据项？').then(function() {
