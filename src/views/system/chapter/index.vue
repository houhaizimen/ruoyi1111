<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="大章id" prop="chapterId">
        <el-input
      ...
      <el-form-item label="章节名" prop="chapreName">
        <el-input
          v-model="queryParams.chapreName"
          placeholder="请输入章节名"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:chapter:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="chapterList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="大章id" align="center" prop="chapterId" />
      <el-table-column label="章节名" align="center" prop="chapreName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="大章id" prop="chapterId">
          <el-input v-model="form.chapterId" placeholder="请输入大章id" />
        </el-form-item>
        <el-form-item label="章节名" prop="chapreName">
          <el-input v-model="form.chapreName" placeholder="请输入章节名" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        chapterId: [
          { required: true, message: "大章id不能为空", trigger: "blur" }
        ],
        chapreName: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除大章id映射编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/chapter/export', {
        ...this.queryParams
